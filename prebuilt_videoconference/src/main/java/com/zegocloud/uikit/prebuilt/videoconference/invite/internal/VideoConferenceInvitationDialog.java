...
import com.zegocloud.uikit.prebuilt.videoconference.databinding.ActivityZegoCallInvitationDialogBinding;
import com.zegocloud.uikit.prebuilt.videoconference.invite.ZegoVideoConferenceInvitationData;

public class VideoConferenceInvitationDialog {

    private Context context;
    private ZegoVideoConferenceInvitationData invitationData;
    private ActivityZegoCallInvitationDialogBinding binding;
    private AlertDialog alertDialog;

    public VideoConferenceInvitationDialog(Context context, ZegoVideoConferenceInvitationData invitationData) {
    ...
    private void initDialogView() {
        ...
        binding.dialogCallAccept.setOnClickListener(v -> {
            hide();
            VideoConferenceInvitation invitation = VideoConferenceInvitation.getFromZegoCallInvitationData(invitationData);
            VideoConferenceInviteActivity.startActivity(context, invitation, false);
