...
import com.zegocloud.uikit.prebuilt.videoconference.invite.ZegoUIKitPrebuiltVideoConferenceConfigProvider;
...
public class InvitationServiceImpl {
    ...
    private VideoConferenceInvitationDialog invitationDialog;
    private ZegoUIKitPrebuiltVideoConferenceConfigProvider provider;
        ...
        public void onInvitationReceived(ZegoUIKitUser inviter, int type, String data) {
            ...
            if (topActivity != null) {
                ...
                try {
                    ...
                    invitationDialog = new VideoConferenceInvitationDialog(topActivity, invitationData);
    ...
    public void setPrebuiltConfigProvider(ZegoUIKitPrebuiltVideoConferenceConfigProvider provider) {
        this.provider = provider;
    }

    public ZegoUIKitPrebuiltVideoConferenceConfigProvider getProvider() {
        return provider;
    }
