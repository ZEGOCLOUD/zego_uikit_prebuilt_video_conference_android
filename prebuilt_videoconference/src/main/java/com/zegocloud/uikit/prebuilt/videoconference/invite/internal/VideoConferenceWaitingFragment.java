...
import com.zegocloud.uikit.prebuilt.videoconference.databinding.LayoutOutgoingCallBinding;
import com.zegocloud.uikit.service.defines.ZegoUIKitUser;

public class VideoConferenceWaitingFragment extends Fragment {

    private LayoutOutgoingCallBinding binding;
    private OnBackPressedCallback onBackPressedCallback;

    public VideoConferenceWaitingFragment() {
    }

    public static VideoConferenceWaitingFragment newInstance(VideoConferenceInvitation invitation) {
        VideoConferenceWaitingFragment fragment = new VideoConferenceWaitingFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        VideoConferenceInvitation invitationData = (VideoConferenceInvitation) getArguments().getParcelable("invitation");
